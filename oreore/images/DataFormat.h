...
namespace OreOreLib
{
	...
	enum DATA_FORMAT
	{
		...
		FORMAT_R8G8B8_SRGB,// Added for vulkan format support. 2021.12.21
		FORMAT_B8G8R8_SRGB,// Added for vulkan format support. 2021.12.21
		FORMAT_B8G8R8A8_UINT,// Added for vulkan format support. 2021.12.21
		FORMAT_B8G8R8A8_SNORM,// Added for vulkan format support. 2021.12.21
		FORMAT_B8G8R8A8_SINT,// Added for vulkan format support. 2021.12.21
		FORMAT_D16_UNORM_S8_UINT,// Added for vulkan support. 2021.12.21
		FORMAT_S8_UINT,
